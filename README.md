...
| [`@parke.dev/pi-herdr`](packages/pi-herdr)                               | 2     | Dispatch tasks to pi agents in [herdr](https://github.com/LukasParke/herdr)-managed worktrees, with PR-review dispatch and worktree trust               |
